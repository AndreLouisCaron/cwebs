...
namespace {
        ...
        ( nix::net::Stream& peer, char * data, std::size_t size )
    {
        ...
        if (!request.complete()) {
            std::cout << "Did not finish HTTP request." << std::endl;
        }
